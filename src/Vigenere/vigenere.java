...
public class vigenere {
    ...
    public static void main(String[] args) {
        ...
        String g1 = "";
        String g2 = "";
        findDuplicates3();

    }

    public static String [] schlüsselzeichengruppe (String g1, int anz){
        String() gruppe = new String[anz];
     ...
     * Ergebnis ist auch falsch, wenn toffset negativ oder größer als die Länge des aufrufenden String-Objektes
     * ist. Der Aufruf startsWith("girls", 10) an obigem String-Objekt liefert demnach
     * true.
     */
    ...
    public static void findDuplicates2() {
        ...
        for (int j = 0; j < text.length() - 2; j++) {
            ...
            for (int i = j + 3; i < text.length() - 2; i++) {
                if (text.startsWith("HOO", i)) {
                    System.out.println("HOO" + ":" + j + ":" + i + ":" + (i - j));
                }
            }
        }
    ...
    public static void findDuplicates3() {
        String text = "HOOLAHOOLAGIRLSLIKEHOOLIGANS";
        for (int l = 15; l > 3; l--) {

            String p = "HOO";

            for (int j = 0; j < text.length() - (l - 1); l--) {
